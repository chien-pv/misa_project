class ItemsController < ApplicationController
  ...
  def input
    ...
    @items = PuOrderDetail.all.includes(:inventory_item).group_by(&:InventoryItemID)
    # binding.pry
    # @items = PuOrderDetail.where(InventoryItemID: pu_order_detail).includes(:inventory_item)
    # binding.pry
